...
/* harmony import */ var _modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_2__);
...
var navMobile = document.querySelector('.wrapper-nav__mobile');
var navToggleClosed = document.querySelector('.main-nav__toggle-closed');
var navToggleOpened = document.querySelector('.wrapper-nav__toggle-opened');
var advantages = document.querySelector('.wrapper-nav__mobile-advantages');
var booking = document.querySelector('.wrapper-nav__mobile-booking');
var cruises = document.querySelector('.wrapper-nav__mobile-cruises');
var contacts = document.querySelector('.wrapper-nav__mobile-contacts');
...
document.addEventListener('click', function (e) {
  var target = e.target;
  var itsTavMobile = target === navMobile || navMobile.contains(target);
  var itsTavToggleClosed = target === navToggleClosed;
  var navMainActive = navMain.classList.contains('wrapper--opened');
